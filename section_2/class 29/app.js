const app = Vue.createApp({
  ...
  // We do NOT return anything because we are not using the watcher anywhere in our HTML to use a return value
  ...
  computed: {
    fullname() {
      ...
      if (this.name === '' || this.lastName === '') { // If either of the two is empty we return an empty full name; || syntax means 'or' 
